...
var activity = [
    ...
    { questionType: 'multiple choice',
      choices: [['1100, 0110, 0011, 1001, ...', false, 'Please try again.  Assume the first two pins are a pair and the second two pins are a pair. (pairs must be different)'],
                ['1001, 0101, 0110, 1010, ...', true, 'Correct!  This pattern is slightly different than the one in the video, but totally valid.  Two valid patterns, one for CW and one for CCW. Start at any point in the loop. Full Step Rules: The two signals in a pair are always different.  One pair changes while the other stays the same.'],
                ['0101, 0110, 1001, 0101, ...', false, 'Please try again.  From step 2 to step 3 both pairs changed, so this one is no good.'],
                ['0101, 1010, 0101, 1010, ...', false, 'Please try again.  Both pairs are changing at the same time here (no good).']],
      outputHeight: '150px'},
    ...
    { questionType: 'multiple choice group',
	      ...
	      {questionHTML: '<b>b.</b> How many transistors would you need for Unipolar wiring?',
	        choices: ['Four MOSFETs', 'Two H-Bridge circuit (ie 1 L293 / 754410)'],
	        correctIndex: 0},
    ...
    { questionType: 'multiple choice',
      choices: [['Your high torque stepper would need to put too much current through the L293 / 754410 and you\'ll destroy the chip.', true, 'Correct.  The H-Bridge we use is limited.  If you get a low resistance stepper consider using a Unipolar wiring with MOSFETs or find a better H-Bridge like an L298 or find something even better online.'],
                ['You won\'t be able to find a power supply above 5 volts', false, 'Please try again.'],
                ['The microcontroller can\'t control higher torque stepper motors', false, 'Please try again.'],
                ['All steppers are low torque, even if you pay over $100.', false, 'Please try again. You can buy steppers with a LOT of torque if you have the funds and a way to drive them.']]},

    '<br><br><b>7.</b> If the Enable line is high, a stepper pulls just as much current while stopped.<br>',

    { questionType: 'multiple choice',
      choices: [['True', true, 'Correct.  If you want to reduce the current bring the enable line to 0.  Otherwise, spinning or not, a stepper pulls max current all the time.'],
